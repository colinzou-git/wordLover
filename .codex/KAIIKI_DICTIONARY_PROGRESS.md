...
- Latest implementation commit: `0342cdb Harden Kaikki Chinese and package validation`
...
- Exact resume step: manually exercise the preview through the active SSH-tunneled server; do not merge to main
