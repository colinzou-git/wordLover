...
import { dictionaryStorageKeys, resolveDictionaryAssetUrl, resolveDictionaryConfig } from "./dictionary-config.js?v=20260701-8";
import {
  formatDomainSuffix,
...
} from "./dictionary-rendering.js?v=20260701-8";
...
import {
  ...
  deriveKek,
} from "./persistence.js?v=20260701-8";

import {
  ratingFromRetries,
  spellingThreshold as _spellingThreshold,
} from "./spelling.js?v=20260701-8";
...
} from "./review-state.js?v=20260701-8";
...
} from "./full-dictionary.js?v=20260701-8";
...
const APP_VERSION = "0.6.2-product.20260701-8-v147";
...
const SHELL_CACHE_VERSION = "wordlover-shell-v147";
