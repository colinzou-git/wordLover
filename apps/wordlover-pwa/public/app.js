import {
  ...
  serializeFsrsCard,
} from "./fsrs-scheduler.js?v=20260714-3";

import { dictionaryStorageKeys, resolveDictionaryAssetUrl, resolveDictionaryConfig } from "./dictionary-config.js?v=20260714-3";
import { userSelectableDictionaries } from "./dictionary-registry.js?v=20260714-3";
import { dictionaryRecordMetadata, readSelectedDictionaryId, saveSelectedDictionaryId } from "./dictionary-selection.js?v=20260714-3";
import {
  formatDomainSuffix,
...
} from "./dictionary-rendering.js?v=20260714-3";
...
import {
  ...
  deriveKek,
} from "./persistence.js?v=20260714-3";

import {
  ratingFromRetries,
  spellingThreshold as _spellingThreshold,
} from "./spelling.js?v=20260714-3";
...
} from "./ui-preferences.js?v=20260714-3";

import { renderOnlineDictionaryActions } from "./online-dictionary-actions.js?v=20260714-3";
import { createUpdateManager, formatUpdateStatus } from "./update-manager.js?v=20260714-3";
...
} from "./review-state.js?v=20260714-3";
...
} from "./study-one-more.js?v=20260714-3";
...
} from "./sync.js?v=20260714-3";

import {
  forecastGoalWorkload,
} from "./goal-forecast.js?v=20260714-3";
...
import {
  ...
  planImport,
  canDeleteTrack,
} from "./tracks.js?v=20260714-3";

import {
  createFullDictionaryClient,
} from "./full-dictionary.js?v=20260714-3";
...
const SHELL_CACHE_VERSION = "wordlover-shell-v159";
